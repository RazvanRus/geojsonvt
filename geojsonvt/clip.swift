...
class Clip {
    ...
    class func clip(features: [ProjectedFeature], scale: Int, k1: Double, k2: Double, axis: Int,
    ...
    class func clipPoints(geometry: ProjectedGeometryContainer, k1: Double, k2: Double, axis: Int) -> ProjectedGeometryContainer {
        ...
        let slice = ProjectedGeometryContainer()
    ...
    class func newSlice( slices: inout ProjectedGeometryContainer, slice: ProjectedGeometryContainer,
